...
public class MathProblems {
    public static void main(String[] args) {
        ...
        System.out.println("int = " + math.sub(1, 2));
        System.out.println("double = " + math.sub(1, 2));
        System.out.println("float = " + math.sub(1, 2));
        System.out.println("int = " + math.multi(1, 2));
        System.out.println("double = " + math.multi(1, 2));
        System.out.println("float = " + math.multi(1, 2));
        System.out.println("int = " + math.div(1, 2));
        System.out.println("double = " + math.div(1, 2));
        System.out.println("float = " + math.div(1, 2));
//         int mynumberone = 1;
//         int mynumbertwo = 950;
